    ...
    return (
      <div className="quickbalance">
          ...
          <div className="item terc20">
            <Dropdown options={this.state.tokenBalance} onChange={this.handleChange} 
            value={this.state.selected_token_name !== '' ? this.state.selected_token_name : 'ERC20'} />
	  </div>
	  <div className="item berc20">
          { this.state.lesDelay === true
            ...
            : <p style={{fontSize: '22px'}}>{ this.state.selected_token_name !== '' ? this.state.balances[this.state.selected_token_name] : '---'}</p>
          }
	  </div>
