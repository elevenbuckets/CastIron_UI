...
var ScheduleTxQList = function (_Reflux$Component) {
  _inherits(ScheduleTxQList, _Reflux$Component);

  function ScheduleTxQList(props) {
    _classCallCheck(this, ScheduleTxQList);

    var _this = _possibleConstructorReturn(this, (ScheduleTxQList.__proto__ || Object.getPrototypeOf(ScheduleTxQList)).call(this, props));
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _this.state.scheduleQueuedTxs.map(function (tx) {
              return _react2.default.createElement(
                'tr',
                null,
                _react2.default.createElement(
                  ...
                  _react2.default.createElement('input', { type: 'button', className: 'xbutton', value: 'X',
                    onClick: _this.handleDequeueSchedule.bind(_this, tx) })
                ),
                _react2.default.createElement(
                  'td',
                  { className: 'txform', width: '32%' },
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement('input', { type: 'button', className: 'button', value: 'Schedule',
                    onClick: _this.handScheduleTxInQueue.bind(_this, tx) })
                )
              );
            })
          )
  ...
  _createClass(ScheduleTxQList, [{
    key: 'handleDequeueSchedule',
    value: function handleDequeueSchedule(tx, event) {
      _CastIronActions2.default.dequeueSchedule(tx);
    }
  }, {
    key: 'handScheduleTxInQueue',
    value: function handScheduleTxInQueue(tx, event) {
      _CastIronActions2.default.scheduleTxInQueue(tx);
      event.target.blur();
    }
  }]);

  return ScheduleTxQList;
